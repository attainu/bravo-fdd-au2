...
allowtransparency="true" allow="encrypted-media"></iframe></div>
       ...
       console.log(this.props.link[0].provider)
    if(this.props.link[0].provider==="spotify"){
        let str=this.props.link[0].url
        let url=(str.slice(0,25)+"embed"+str.slice(24))
        console.log(url)
        var iframe= <iframe src={url} width="100%" height="80" frameborder="0" 
        allowtransparency="true" allow="encrypted-media"></iframe>
       }
       else if(this.props.link[0].provider==="soundcloud"){
        let url=this.props.link[0].url
        console.log(url)
       ...
       else if(this.props.link[0].provider==="youtube"){
        let str=this.props.link[0].url
